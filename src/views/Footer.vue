        ...
        <v-col class="px-1" cols="12" xl="3" lg="3" md="3">
          <div class="widget-contact-us">
            ...
            <ul class="items">
              ...
              <li class="item mb-2">
                <v-icon class="ml-2" color="red">mdi-phone-outline</v-icon>
                2222 222 21 98+
              </li>
              <li class="item mb-2">
                <v-icon class="ml-2" color="red">mdi-email-outline</v-icon>
                <a class="link" href="mailto:first.last@example.com"
                  >customer@tovsee.ir</a
                >
              </li>
            </ul>
          </div>
